...
# [-5:-1] 하면 -1은 포함이 아닌라서 다른 걸 적어야 하는데,
# [-5:] 이렇게 쓰는 건 파이썬만 되는 거라, len(dataAry)를 넣는 건가?
print('#정렬 배열(100만개) :', sortedAry[0:5], '~~~', dataAry[-5:len(sortedAry)])
